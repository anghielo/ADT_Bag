/** Java code for demonstrating union, intersection and difference, as defined in the
 	interface BagInterface.java and implemented in the class ResizeableArrayBag.java. */
public class ArrayBagTest {
	public static void main(String[] args) {
		System.out.print("======================== ARRAYBAG TEST ========================\n\n");
		
		// Creating string bags
		BagInterface<String> stringBag1 = new ResizeableArrayBag<String>();
		BagInterface<String> stringBag2 = new ResizeableArrayBag<String>();
		...
		BagInterface<Integer> integerBag1 = new ResizeableArrayBag<Integer>();
		BagInterface<Integer> integerBag2 = new ResizeableArrayBag<Integer>();
